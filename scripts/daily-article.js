...
const TOPICS = {
  ...
  'ai-prompts': [
    '50 Best ChatGPT Prompts for Creative Writing and Storytelling',
    'Top Midjourney Prompts for Generating Stunning Realistic Portraits',
    'The Ultimate Stable Diffusion Prompt Guide: Styles, Modifiers and Tricks',
    'Best Claude Prompts for Deep Research and Long-Form Analysis',
    '30 Advanced ChatGPT Prompts for Complex Problem Solving',
    'Midjourney v6 Prompts for Photorealistic Landscape Photography',
    'Top DALL-E 3 Prompts for Creating Unique Digital Art',
    ...
    'Best Prompts for AI Video Generation with Sora and Runway',
    'Role Prompting Mastery: Make Any LLM Think Like an Expert',
    'Top Prompts for Generating Infographics and Data Visualizations with AI',
    ...
    'Top AI Prompts for Generating Full UI/UX Designs from Text Descriptions',
    '20 Meta-Prompts That Help You Write Better Prompts Automatically',
...
async function publishArticleForCategory(catSlug, existingTitles, provider, rssTitles, corpus) {
  ...
  if (!topic) {
    log(`⚠ All topics for ${category.name} already covered by external sources, skipping.`);
    return null;
  }
  log(`Topic: "${topic}"`);
